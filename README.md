...
### 3. License GrantKiryly Tupikou hereby grants you a personal, non-transferable, non-exclusive licence to use the foYou software on your devices in accordance with the terms of this EULA agreement.

    You are permitted to load the foYou software (for example a PC, laptop, mobile or tablet) under your control. You are responsible for ensuring your device meets the minimum requirements of the foYou software.
...
## Privacy Policy
    ...
    Kiryl Tupikou  ("us", "we", or "our") operates the foYou mobile application (the "Service").This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.
